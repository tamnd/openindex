// Package postings is the posting-list codec (indexer doc 05.2): 128-document
// blocks, Frame-of-Reference bit-packing for delta-encoded document IDs, a
// group-varint tail for the final under-128 block, and per-block max metadata
...
// varint, small enough that a skip lands close to the target (doc 05.2).
const BlockSize = 128
